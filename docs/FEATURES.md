...
| c. Common taxonomy | AEGIS schema, typed IPs/ports, time basis, action/severity/event category, unmapped attributes | Inspired by OCSF concepts. No full OCSF conformance claim. |
...
| Universal normalization | AEGIS envelope, attributes, unmapped data, raw ref/hash, provenance | Implemented; finite adapters and review boundary |
